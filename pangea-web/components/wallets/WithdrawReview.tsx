...
export const WithdrawReview = (): JSX.Element => {
  ...
  const destinationAccount = beneficiaryAccounts?.find(
    ...
    <>
                ...
                <Typography variant='dataBody'>
                  {sourceWallet
                    ? `${
                      ...
                      } Wallet (...${sourceWallet.wallet_id.slice(
                        -4,
                      )}) sends exactly`
                    : ''}
                </Typography>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <Stack>
                <Typography variant='dataBody'>
                  {destinationAccount
                    ? `${destinationAccount.beneficiary_name} - ${destinationAccount.destination_currency} - ${destinationAccount.bank_name} receives approx.`
                    : ''}
                </Typography>
      ...
      >
        <Stack spacing={0}>
          ...
          <SummaryDataPoint label='Fees' value={'N/A'} />
        </Stack>
      </StyledBox>
    </>
  );
