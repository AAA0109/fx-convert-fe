...
export interface PangeaActivities {
  activities: PangeaActivity[];
}
...
export interface PangeaBankStatements {
  statements: PangeaBankStatement[];
}
...
export interface PangeaFeePayment {
  description: string;
  account_hedge_request_id: number | null;
  /** @format double */
  amount: number;
  /** @format date-time */
  date: string;
...
export interface PangeaFeesPayments {
  fees_and_payments: PangeaFeePayment[];
}
...
export interface PangeaHistoryActivitiesRetrieveParams {
  /** @format date-time */
  end_date?: string;
  /** @format date-time */
  start_date?: string;
...
export interface PangeaHistoryFeesPaymentsRetrieveParams {
  /** @format date-time */
  end_date?: string;
  /** @format date-time */
  start_date?: string;
...
export interface PangeaHistoryBankStatementsRetrieveParams {
  /** @format date-time */
  end_date?: string;
  /** @format date-time */
  start_date?: string;
...
export interface PangeaHistoryTradesRetrieveParams {
  /** @format date-time */
  end_date?: string;
  /** @format date-time */
  start_date?: string;
