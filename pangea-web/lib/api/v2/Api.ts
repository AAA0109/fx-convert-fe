...
import {
  ...
  PangeaHistoryActivitiesListParams,
  PangeaHistoryBankStatementsListParams,
  PangeaHistoryFeesPaymentsListParams,
  PangeaHistoryTradesListParams,
  ...
  PangeaPaginatedActivityList,
  PangeaPaginatedBankStatementList,
  ...
  PangeaPaginatedFeesPaymentsList,
...
> extends HttpClient<SecurityDataType> {
   ...
   * @request PUT:/api/v2/cashflow/{cashflow_id}/
   * @secure
   */
  cashflowUpdate = (
    cashflowId: string,
    ...
    this.request<PangeaCashFlowGenerator, any>({
      path: `/api/v2/cashflow/${cashflowId}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request DELETE:/api/v2/cashflow/{cashflow_id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/cashflow/{cashflow_id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/cashflow/{cashflow_id}/
   * @secure
   */
   ...
   * @request POST:/api/v2/settlement/beneficiary/
   * @secure
   */
  settlementBeneficiaryCreate = (
    ...
    this.request<PangeaBeneficiary, any>({
      path: `/api/v2/settlement/beneficiary/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/settlement/beneficiary/
   * @secure
   */
   ...
   * @request POST:/api/v2/settlement/beneficiary/activate/
   * @secure
   */
  settlementBeneficiaryActivateCreate = (
    ...
    this.request<PangeaMessageResponse, PangeaMessageResponse>({
      path: `/api/v2/settlement/beneficiary/activate/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/settlement/beneficiary/bank_search/
   * @secure
   */
  settlementBeneficiaryBankSearchRetrieve = (params: RequestParams = {}) =>
    this.request<PangeaBeneficiary, any>({
      path: `/api/v2/settlement/beneficiary/bank_search/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/settlement/beneficiary/validation_schema/
   * @secure
   */
  settlementBeneficiaryValidationSchemaCreate = (
    ...
    this.request<PangeaBeneficiary, any>({
      path: `/api/v2/settlement/beneficiary/validation_schema/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request PUT:/api/v2/settlement/beneficiary/{id}/
   * @secure
   */
  settlementBeneficiaryUpdate = (
    ...
    this.request<PangeaBeneficiary, any>({
      path: `/api/v2/settlement/beneficiary/${id}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request DELETE:/api/v2/settlement/beneficiary/{id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/settlement/beneficiary/{id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/settlement/beneficiary/{id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/settlement/wallet/
   * @secure
   */
   ...
   * @request PUT:/api/v2/settlement/wallet/{wallet_id}/
   * @secure
   */
  settlementWalletUpdate = (
    ...
    this.request<PangeaWallet, any>({
      path: `/api/v2/settlement/wallet/${walletId}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request DELETE:/api/v2/settlement/wallet/{wallet_id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/settlement/wallet/{wallet_id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/settlement/wallet/{wallet_id}/
   * @secure
   */
   ...
   * @request POST:/api/v2/oems/execute-rfq/
   * @secure
   */
  oemsExecuteRfqCreate = (data: PangeaExecuteRfq, params: RequestParams = {}) =>
    this.request<Record<string, any>, PangeaError>({
      path: `/api/v2/oems/execute-rfq/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @summary Status
   * @request GET:/api/v2/oems/status/{ticket_id}/
   * @secure
   */
  oemsStatusRetrieve = (ticketId: string, params: RequestParams = {}) =>
    this.request<Record<string, any>, PangeaError>({
      path: `/api/v2/oems/status/${ticketId}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/oems/execution/
   * @secure
   */
  oemsExecutionRetrieve = (params: RequestParams = {}) =>
    this.request<Record<string, any>, PangeaError>({
      path: `/api/v2/oems/execution/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/oems/execute/activate/
   * @secure
   */
  oemsExecuteActivateCreate = (
    ...
    this.request<Record<string, any>, PangeaError>({
      path: `/api/v2/oems/execute/activate/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/execute/authorize/
   * @secure
   */
  oemsExecuteAuthorizeCreate = (
    ...
    this.request<Record<string, any>, PangeaError>({
      path: `/api/v2/oems/execute/authorize/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/execute/cancel/
   * @secure
   */
  oemsExecuteCancelCreate = (
    ...
    this.request<Record<string, any>, PangeaError>({
      path: `/api/v2/oems/execute/cancel/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/execute/pause/
   * @secure
   */
  oemsExecutePauseCreate = (
    ...
    this.request<Record<string, any>, PangeaError>({
      path: `/api/v2/oems/execute/pause/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/execute/resume/
   * @secure
   */
  oemsExecuteResumeCreate = (
    ...
    this.request<Record<string, any>, PangeaError>({
      path: `/api/v2/oems/execute/resume/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/oems/cny-execution/
   * @secure
   */
  oemsCnyExecutionList = (
    ...
    this.request<PangeaCnyExecution[], any>({
      path: `/api/v2/oems/cny-execution/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @tags oems
   * @name OemsTicketList
   * @request GET:/api/v2/oems/ticket/
   * @secure
   */
  oemsTicketList = (
   ...
   * @request GET:/api/v2/oems/ticket/{id}/
   * @secure
   */
  oemsTicketRetrieve = (id: number, params: RequestParams = {}) =>
    this.request<PangeaTicket, any>({
      path: `/api/v2/oems/ticket/${id}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/oems/execute/best-execution
   * @secure
   */
  oemsExecuteBestExecutionCreate = (
    ...
    this.request<PangeaBestExecution, PangeaError>({
      path: `/api/v2/oems/execute/best-execution`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/order-quote/
   * @secure
   */
   ...
   * @request POST:/api/v2/oems/quote-to-ticket/
   * @secure
   */
  oemsQuoteToTicketCreate = (
    ...
    this.request<PangeaTicket, any>({
      path: `/api/v2/oems/quote-to-ticket/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/wait-condition/
   * @secure
   */
  oemsWaitConditionCreate = (
    ...
    this.request<PangeaWaitCondition, any>({
      path: `/api/v2/oems/wait-condition/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/manual-request-slack-form/
   * @secure
   */
  oemsManualRequestSlackFormCreate = (
    ...
    this.request<PangeaManualRequest, any>({
      path: `/api/v2/oems/manual-request-slack-form/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request DELETE:/api/v2/oems/manual-request-slack-form/
   * @secure
   */
   ...
   * @request PUT:/api/v2/oems/manual-request-slack-form/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/oems/manual-request-slack-form/
   * @secure
   */
   ...
   * @request POST:/api/v2/oems/calendar/non-settlement-days
   * @secure
   */
  oemsCalendarNonSettlementDaysCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/non-settlement-days`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/settlement-days
   * @secure
   */
  oemsCalendarSettlementDaysCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/settlement-days`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/valid-settlement-day
   * @secure
   */
  oemsCalendarValidSettlementDayCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/valid-settlement-day`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/next-valid-settlement-day
   * @secure
   */
  oemsCalendarNextValidSettlementDayCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/next-valid-settlement-day`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/prev-valid-settlement-day
   * @secure
   */
  oemsCalendarPrevValidSettlementDayCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/prev-valid-settlement-day`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/next-mkt-day
   * @secure
   */
  oemsCalendarNextMktDayCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/next-mkt-day`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/current-mkt-day
   * @secure
   */
  oemsCalendarCurrentMktDayCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/current-mkt-day`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/fx-settlement-info
   * @secure
   */
  oemsCalendarFxSettlementInfoCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/fx-settlement-info`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/spot-value-date
   * @secure
   */
  oemsCalendarSpotValueDateCreate = (
    ...
    this.request<void, any>({
      path: `/api/v2/oems/calendar/spot-value-date`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/oems/calendar/value-dates
   * @secure
   */
  oemsCalendarValueDatesCreate = (
    ...
    this.request<string[], any>({
      path: `/api/v2/oems/calendar/value-dates`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/oems/best-execution-timing/{payment_id}/
   * @secure
   */
  oemsBestExecutionTimingRetrieve = (
    ...
    this.request<PangeaBestExecutionTiming, any>({
      path: `/api/v2/oems/best-execution-timing/${paymentId}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/oems/liquidity-insight/
   * @secure
   */
  oemsLiquidityInsightCreate = (
    ...
    this.request<PangeaLiquidityInsightResponse, any>({
      path: `/api/v2/oems/liquidity-insight/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/marketdata/recent-rate/
   * @secure
   */
  marketdataRecentRateCreate = (
    ...
    this.request<PangeaRecentRateResponse, PangeaError>({
      path: `/api/v2/marketdata/recent-rate/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/marketdata/historical-rates/
   * @secure
   */
  marketdataHistoricalRatesCreate = (
    ...
    this.request<PangeaRateMovingAverage[], PangeaError>({
      path: `/api/v2/marketdata/historical-rates/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @summary Market Risk
   * @request POST:/api/v2/marketdata/risk/
   * @secure
   */
   ...
   * @request GET:/api/v2/marketdata/spot/
   * @secure
   */
  marketdataSpotList = (
   ...
   * @request GET:/api/v2/marketdata/spot/intra/
   * @secure
   */
  marketdataSpotIntraList = (
    ...
    this.request<PangeaPaginatedFxSpotIntraList, any>({
      path: `/api/v2/marketdata/spot/intra/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/spot/corpay/
   * @secure
   */
  marketdataSpotCorpayList = (
    ...
    this.request<PangeaPaginatedCorPayFxSpotList, any>({
      path: `/api/v2/marketdata/spot/corpay/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/forwards/
   * @secure
   */
  marketdataForwardsList = (
    ...
    this.request<PangeaPaginatedFxForwardList, any>({
      path: `/api/v2/marketdata/forwards/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/forwards/corpay/
   * @secure
   */
  marketdataForwardsCorpayList = (
    ...
    this.request<PangeaPaginatedCorPayFxForwardList, any>({
      path: `/api/v2/marketdata/forwards/corpay/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/trading_calendar/
   * @secure
   */
  marketdataTradingCalendarList = (
    ...
    this.request<PangeaPaginatedTradingCalendarList, any>({
      path: `/api/v2/marketdata/trading_calendar/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/spot/intra/average/
   * @secure
   */
  marketdataSpotIntraAverageRetrieve = (
    ...
    this.request<PangeaAverageFxSpotPrice, any>({
      path: `/api/v2/marketdata/spot/intra/average/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/fxPair/p10/
   * @secure
   */
  marketdataFxPairP10List = (
    ...
    this.request<PangeaPaginatedFxPairList, any>({
      path: `/api/v2/marketdata/fxPair/p10/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/future/intra/
   * @secure
   */
  marketdataFutureIntraList = (
    ...
    this.request<PangeaFutureIntra[], any>({
      path: `/api/v2/marketdata/future/intra/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/future/liquid_hours/
   * @secure
   */
  marketdataFutureLiquidHoursList = (
    ...
    this.request<PangeaPaginatedLiquidHoursList, any>({
      path: `/api/v2/marketdata/future/liquid_hours/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/future/trading_hours/
   * @secure
   */
  marketdataFutureTradingHoursList = (
    ...
    this.request<PangeaPaginatedTradingHoursList, any>({
      path: `/api/v2/marketdata/future/trading_hours/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/marketdata/asset/index/
   * @secure
   */
  marketdataAssetIndexList = (
    ...
    this.request<PangeaPaginatedIndexList, any>({
      path: `/api/v2/marketdata/asset/index/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/marketdata/initial-state/
   * @secure
   */
  marketdataInitialStateCreate = (
    ...
    this.request<PangeaInitialMarketStateResponse, PangeaError>({
      path: `/api/v2/marketdata/initial-state/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/webhook/events/
   * @secure
   */
  webhookEventsList = (
   ...
   * @request GET:/api/v2/webhook/event-groups/
   * @secure
   */
  webhookEventGroupsList = (
    ...
    this.request<PangeaPaginatedEventGroupList, any>({
      path: `/api/v2/webhook/event-groups/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request PUT:/api/v2/webhook/{webhook_id}/
   * @secure
   */
  webhookUpdate = (
    webhookId: string,
   ...
   * @request DELETE:/api/v2/webhook/{webhook_id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/webhook/{webhook_id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/webhook/{webhook_id}/
   * @secure
   */
   ...
   * @request PUT:/api/v2/accounts/{id}/activate/
   * @secure
   */
   ...
   * @request PUT:/api/v2/accounts/{id}/deactivate/
   * @secure
   */
  accountsDeactivateUpdate = (id: number, params: RequestParams = {}) =>
    this.request<PangeaAccount, any>({
      path: `/api/v2/accounts/${id}/deactivate/`,
      method: 'PUT',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/accounts/{id}/set_hedge_policy/
   * @secure
   */
  accountsSetHedgePolicyCreate = (
    ...
    this.request<PangeaHedgeSettings, any>({
      path: `/api/v2/accounts/${id}/set_hedge_policy/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/installments/
   * @secure
   */
  installmentsList = (
   ...
   * @request DELETE:/api/v2/installments/{id}/
   * @secure
   */
  installmentsDestroy = (id: number, params: RequestParams = {}) =>
    this.request<void, any>({
      path: `/api/v2/installments/${id}/`,
      method: 'DELETE',
      secure: true,
      ...params,
    });
   ...
   * @request PUT:/api/v2/installments/{id}/
   * @secure
   */
  installmentsUpdate = (
    id: number,
   ...
   * @request GET:/api/v2/installments/{id}/
   * @secure
   */
   ...
   * @request PUT:/api/v2/company/deactivate/
   * @secure
   */
  companyDeactivateUpdate = (params: RequestParams = {}) =>
    this.request<void, any>({
      path: `/api/v2/company/deactivate/`,
      method: 'PUT',
      secure: true,
      ...params,
    });
   ...
   * @request PATCH:/api/v2/company/{id}/
   * @secure
   */
   ...
   * @tags drafts
   * @name DraftsDestroy
   * @request DELETE:/api/v2/drafts/{id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/drafts/{id}/
   * @secure
   */
  draftsPartialUpdate = (
    id: number,
   ...
   * @request POST:/api/v2/accounts/{account_pk}/parachute_data/
   * @secure
   */
  accountsParachuteDataCreate = (
    ...
    this.request<PangeaParachuteData, any>({
      path: `/api/v2/accounts/${accountPk}/parachute_data/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request PUT:/api/v2/accounts/{account_pk}/parachute_data/{id}/
   * @secure
   */
  accountsParachuteDataUpdate = (
    ...
    this.request<PangeaParachuteData, any>({
      path: `/api/v2/accounts/${accountPk}/parachute_data/${id}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/accounts/{account_pk}/parachute_data/{id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/accounts/{account_pk}/parachute_data/{id}/
   * @secure
   */
   ...
   * @request POST:/api/v2/accounts/{account_pk}/autopilot_data/
   * @secure
   */
  accountsAutopilotDataCreate = (
    ...
    this.request<PangeaAutopilotData, any>({
      path: `/api/v2/accounts/${accountPk}/autopilot_data/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request PUT:/api/v2/accounts/{account_pk}/autopilot_data/{id}/
   * @secure
   */
  accountsAutopilotDataUpdate = (
    ...
    this.request<PangeaAutopilotData, any>({
      path: `/api/v2/accounts/${accountPk}/autopilot_data/${id}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/accounts/{account_pk}/autopilot_data/{id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/accounts/{account_pk}/autopilot_data/{id}/
   * @secure
   */
   ...
   * @request POST:/api/v2/accounts/{account_pk}/cashflow/
   * @secure
   */
  accountsCashflowCreate = (
    ...
    this.request<PangeaCashflow, PangeaCashFlowActionStatus>({
      path: `/api/v2/accounts/${accountPk}/cashflow/`,
      method: 'POST',
      query: query,
      body: data,
      secure: true,
   ...
   * @request GET:/api/v2/accounts/{account_pk}/cashflow/
   * @secure
   */
   ...
   * @request PUT:/api/v2/accounts/{account_pk}/cashflow/{id}/
   * @secure
   */
  accountsCashflowUpdate = (
    ...
    this.request<PangeaCashflow, PangeaCashFlowActionStatus>({
      path: `/api/v2/accounts/${accountPk}/cashflow/${id}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request DELETE:/api/v2/accounts/{account_pk}/cashflow/{id}/
   * @secure
   */
   ...
   * @request POST:/api/v2/accounts/{account_pk}/cashflow/{id}/approve/
   * @secure
   */
  accountsCashflowApproveCreate = (
    ...
    this.request<PangeaCashflow, any>({
      path: `/api/v2/accounts/${accountPk}/cashflow/${id}/approve/`,
      method: 'POST',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/accounts/{account_pk}/cashflow/{cashflow_pk}/notes/
   * @secure
   */
  accountsCashflowNotesCreate = (
    ...
    this.request<PangeaCashflowNote, any>({
      path: `/api/v2/accounts/${accountPk}/cashflow/${cashflowPk}/notes/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/accounts/{account_pk}/cashflow/{cashflow_pk}/notes/
   * @secure
   */
   ...
   * @request PUT:/api/v2/accounts/{account_pk}/cashflow/{cashflow_pk}/notes/{id}/
   * @secure
   */
  accountsCashflowNotesUpdate = (
    ...
    this.request<PangeaCashflowNote, any>({
      path: `/api/v2/accounts/${accountPk}/cashflow/${cashflowPk}/notes/${id}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/accounts/{account_pk}/cashflow/{cashflow_pk}/draft/
   * @secure
   */
  accountsCashflowDraftCreate = (
    ...
    this.request<PangeaDraftCashflow, any>({
      path: `/api/v2/accounts/${accountPk}/cashflow/${cashflowPk}/draft/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request PUT:/api/v2/accounts/{account_pk}/cashflow/{cashflow_pk}/draft/{id}/
   * @secure
   */
  accountsCashflowDraftUpdate = (
    ...
    this.request<PangeaDraftCashflow, any>({
      path: `/api/v2/accounts/${accountPk}/cashflow/${cashflowPk}/draft/${id}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request DELETE:/api/v2/accounts/{account_pk}/cashflow/{cashflow_pk}/draft/{id}/
   * @secure
   */
   ...
   * @request PUT:/api/v2/accounts/{account_pk}/cashflow/{cashflow_pk}/draft/{id}/activate/
   * @secure
   */
  accountsCashflowDraftActivateUpdate = (
    ...
    this.request<PangeaCashflow, PangeaCashFlowActionStatus>({
      path: `/api/v2/accounts/${accountPk}/cashflow/${cashflowPk}/draft/${id}/activate/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/company/{company_pk}/user/
   * @secure
   */
  companyUserList = (companyPk: number, params: RequestParams = {}) =>
    this.request<PangeaUser[], any>({
      path: `/api/v2/company/${companyPk}/user/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/company/{company_pk}/contact_order/
   * @secure
   */
  companyContactOrderCreate = (
    ...
    this.request<PangeaActionStatus, PangeaActionStatus>({
      path: `/api/v2/company/${companyPk}/contact_order/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/company/{company_pk}/contact_order/
   * @secure
   */
   ...
   * @request GET:/api/v2/company/{company_pk}/join_request/
   * @secure
   */
  companyJoinRequestList = (
    ...
    this.request<PangeaPaginatedCompanyJoinRequestList, any>({
      path: `/api/v2/company/${companyPk}/join_request/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/company/{company_pk}/join_request/{id}/
   * @secure
   */
  companyJoinRequestRetrieve = (
    ...
    this.request<PangeaCompanyJoinRequest, any>({
      path: `/api/v2/company/${companyPk}/join_request/${id}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/invite/confirm
   * @secure
   */
  inviteConfirmCreate = (
   ...
   * @request GET:/api/v2/invite/verify-token
   * @secure
   */
  inviteVerifyTokenRetrieve = (
    ...
    this.request<PangeaInviteTokenResponse, PangeaInviteTokenError>({
      path: `/api/v2/invite/verify-token`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/user/activate
   * @secure
   */
   ...
   * @request GET:/api/v2/user/exists
   * @secure
   */
  userExistsRetrieve = (
   ...
   * @request POST:/api/v2/user/phone/confirm
   * @secure
   */
   ...
   * @request POST:/api/v2/user/phone/verify-otp
   * @secure
   */
  userPhoneVerifyOtpCreate = (
    ...
    this.request<PangeaStatusResponse, PangeaStatusResponse>({
      path: `/api/v2/user/phone/verify-otp`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request PUT:/api/v2/user/{id}/permission
   * @secure
   */
  userPermissionUpdate = (
    ...
    this.request<PangeaUser, any>({
      path: `/api/v2/user/${id}/permission`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request PATCH:/api/v2/user/{id}/permission
   * @secure
   */
   ...
   * @request PUT:/api/v2/user/{id}/remove
   * @secure
   */
  userRemoveUpdate = (id: number, params: RequestParams = {}) =>
    this.request<PangeaUser, any>({
      path: `/api/v2/user/${id}/remove`,
      method: 'PUT',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request PATCH:/api/v2/user/{id}/remove
   * @secure
   */
   ...
   * @request PUT:/api/v2/password/change-password
   * @secure
   */
  passwordChangePasswordUpdate = (
    ...
    this.request<PangeaActionStatus, PangeaActionStatus>({
      path: `/api/v2/password/change-password`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/password/password-reset/validate_token/
   */
  passwordPasswordResetValidateTokenCreate = (
    ...
    this.request<PangeaResetToken, any>({
      path: `/api/v2/password/password-reset/validate_token/`,
      method: 'POST',
      body: data,
      type: ContentType.Json,
      format: 'json',
   ...
   * @request POST:/api/v2/password/password-reset/confirm/
   */
  passwordPasswordResetConfirmCreate = (
    ...
    this.request<PangeaPasswordToken, any>({
      path: `/api/v2/password/password-reset/confirm/`,
      method: 'POST',
      body: data,
      type: ContentType.Json,
      format: 'json',
   ...
   * @request POST:/api/v2/password/password-reset/
   */
  passwordPasswordResetCreate = (
    ...
    this.request<PangeaEmail, any>({
      path: `/api/v2/password/password-reset/`,
      method: 'POST',
      body: data,
      type: ContentType.Json,
      format: 'json',
   ...
   * @request POST:/api/v2/support/message
   * @secure
   */
   ...
   * @request POST:/api/v2/support/general/message
   * @secure
   */
  supportGeneralMessageCreate = (
    ...
    this.request<PangeaActionStatus, PangeaActionStatus>({
      path: `/api/v2/support/general/message`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/company/ein
   * @secure
   */
  companyEinCreate = (
   ...
   * @request POST:/api/v2/company/{company_pk}/join_request
   * @secure
   */
   ...
   * @request POST:/api/v2/company/{company_pk}/join_request/{id}/approve
   * @secure
   */
  companyJoinRequestApproveCreate = (
    ...
    this.request<PangeaCompanyJoinRequest, any>({
      path: `/api/v2/company/${companyPk}/join_request/${id}/approve`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/company/{company_pk}/join_request/{id}/reject
   * @secure
   */
  companyJoinRequestRejectCreate = (
    ...
    this.request<PangeaCompanyJoinRequest, any>({
      path: `/api/v2/company/${companyPk}/join_request/${id}/reject`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/auth/{method}/activate/
   * @secure
   */
  authActivateCreate = (method: string, params: RequestParams = {}) =>
    this.request<
      ...
      PangeaMFAMethodActivationErrorResponse
    >({
      path: `/api/v2/auth/${method}/activate/`,
      method: 'POST',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/auth/{method}/activate/confirm/
   * @secure
   */
  authActivateConfirmCreate = (
    ...
    this.request<
      ...
      PangeaMFAMethodCodeErrorResponse
    >({
      path: `/api/v2/auth/${method}/activate/confirm/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/auth/{method}/deactivate/
   * @secure
   */
  authDeactivateCreate = (
    ...
    this.request<void, PangeaMFAMethodCodeErrorResponse>({
      path: `/api/v2/auth/${method}/deactivate/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/auth/{method}/codes/regenerate/
   * @secure
   */
  authCodesRegenerateCreate = (
    ...
    this.request<
      ...
      PangeaMFAMethodCodeErrorResponse
    >({
      path: `/api/v2/auth/${method}/codes/regenerate/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/auth/code/request/
   * @secure
   */
   ...
   * @request GET:/api/v2/auth/mfa/user-active-methods/
   * @secure
   */
  authMfaUserActiveMethodsList = (
    ...
    this.request<PangeaMFAActiveUserMethod[], any>({
      path: `/api/v2/auth/mfa/user-active-methods/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/auth/mfa/change-primary-method/
   * @secure
   */
  authMfaChangePrimaryMethodCreate = (
    ...
    this.request<void, PangeaMFAMethodCodeErrorResponse>({
      path: `/api/v2/auth/mfa/change-primary-method/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/auth/login/code/
   * @secure
   */
  authLoginCodeCreate = (
   ...
   * @request GET:/api/v2/currency/currencies/
   * @secure
   */
  currencyCurrenciesList = (params: RequestParams = {}) =>
    this.request<PangeaCurrency[], any>({
      path: `/api/v2/currency/currencies/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/currency/currencies/{mnemonic}/
   * @secure
   */
  currencyCurrenciesRetrieve = (mnemonic: string, params: RequestParams = {}) =>
    this.request<PangeaCurrency, any>({
      path: `/api/v2/currency/currencies/${mnemonic}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/currency/stability-index/{mnemonic}/{year}
   * @secure
   */
  currencyStabilityIndexRetrieve = (
    ...
    this.request<PangeaStabilityIndex, any>({
      path: `/api/v2/currency/stability-index/${mnemonic}/${year}`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/currency/fxpairs/
   * @secure
   */
  currencyFxpairsList = (
   ...
   * @request GET:/api/v2/currency/delivery-time/
   * @secure
   */
  currencyDeliveryTimeList = (
    ...
    this.request<PangeaPaginatedCurrencyDeliveryList, any>({
      path: `/api/v2/currency/delivery-time/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/currency/currency-deliverytime/{mnemonic}/
   * @secure
   */
  currencyCurrencyDeliverytimeRetrieve = (
    ...
    this.request<PangeaCurrencyDelivery, any>({
      path: `/api/v2/currency/currency-deliverytime/${mnemonic}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/country/country_code/{country_code}/
   * @secure
   */
  countryCountryCodeRetrieve = (
    ...
    this.request<void, any>({
      path: `/api/v2/country/country_code/${countryCode}/`,
      method: 'GET',
      secure: true,
      ...params,
    });
   ...
   * @request GET:/api/v2/country/mnemonic/{mnemonic}/
   * @secure
   */
  countryMnemonicRetrieve = (mnemonic: string, params: RequestParams = {}) =>
    this.request<void, any>({
      path: `/api/v2/country/mnemonic/${mnemonic}/`,
      method: 'GET',
      secure: true,
      ...params,
    });
   ...
   * @request POST:/api/v2/risk/get_cashflow_risk_cones/
   * @secure
   */
  riskGetCashflowRiskConesCreate = (
    ...
    this.request<PangeaGetCashflowRiskConeResponse, any>({
      path: `/api/v2/risk/get_cashflow_risk_cones/`,
      method: 'POST',
      query: query,
      body: data,
      secure: true,
   ...
   * @request POST:/api/v2/risk/margin_and_fees/
   * @secure
   */
  riskMarginAndFeesCreate = (
    ...
    this.request<PangeaMarginAndFeesResponse, any>({
      path: `/api/v2/risk/margin_and_fees/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/risk/margin_health/
   * @secure
   */
  riskMarginHealthCreate = (
    ...
    this.request<PangeaMarginHealthResponse, any>({
      path: `/api/v2/risk/margin_health/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/hedge/positions/
   * @secure
   */
  hedgePositionsRetrieve = (params: RequestParams = {}) =>
    this.request<PangeaActionStatus, PangeaActionStatus>({
      path: `/api/v2/hedge/positions/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/hedge/realized_pnl/
   * @secure
   */
  hedgeRealizedPnlRetrieve = (params: RequestParams = {}) =>
    this.request<void, any>({
      path: `/api/v2/hedge/realized_pnl/`,
      method: 'GET',
      secure: true,
      ...params,
    });
   ...
   * @request GET:/api/v2/hedge/realized_variance/
   * @secure
   */
  hedgeRealizedVarianceRetrieve = (params: RequestParams = {}) =>
    this.request<PangeaActionStatus, PangeaActionStatus>({
      path: `/api/v2/hedge/realized_variance/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/hedge/unrealized_pnl/
   * @secure
   */
  hedgeUnrealizedPnlRetrieve = (params: RequestParams = {}) =>
    this.request<PangeaActionStatus, PangeaActionStatus>({
      path: `/api/v2/hedge/unrealized_pnl/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/hedge/forward/update/request/
   * @secure
   */
  hedgeForwardUpdateRequestCreate = (
    ...
    this.request<PangeaUpdateRequest, any>({
      path: `/api/v2/hedge/forward/update/request/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/hedge/forward/
   * @secure
   */
  hedgeForwardCreate = (
   ...
   * @request GET:/api/v2/hedge/forward/
   * @secure
   */
  hedgeForwardList = (
   ...
   * @request PUT:/api/v2/hedge/forward/{id}/
   * @secure
   */
  hedgeForwardUpdate = (
    id: number,
   ...
   * @request DELETE:/api/v2/hedge/forward/{id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/hedge/forward/{id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/hedge/forward/{id}/
   * @secure
   */
   ...
   * @request PUT:/api/v2/hedge/forward/{id}/activate/
   * @secure
   */
  hedgeForwardActivateUpdate = (
    ...
    this.request<PangeaDraftFxForward, any>({
      path: `/api/v2/hedge/forward/${id}/activate/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/hedge/forward/{id}/what_if/
   * @secure
   */
  hedgeForwardWhatIfRetrieve = (
    ...
    this.request<PangeaWhatIf, PangeaMessageResponse>({
      path: `/api/v2/hedge/forward/${id}/what_if/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/payments/stripe/setup_intent
   * @secure
   */
   ...
   * @request POST:/api/v2/payments/stripe/payment_method
   * @secure
   */
  paymentsStripePaymentMethodCreate = (
    ...
    this.request<PangeaStripePaymentMethodResponse, any>({
      path: `/api/v2/payments/stripe/payment_method`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @tags payments
   * @name PaymentsUpdate
   * @request PUT:/api/v2/payments/{id}/
   * @secure
   */
  paymentsUpdate = (
    id: number,
   ...
   * @request DELETE:/api/v2/payments/{id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/payments/{id}/
   * @secure
   */
   ...
   * @request POST:/api/v2/payments/calendar/value-date/
   * @secure
   */
  paymentsCalendarValueDateCreate = (
    ...
    this.request<PangeaValueDateCalendarResponse, any>({
      path: `/api/v2/payments/calendar/value-date/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/payments/{payment_id}/cashflows/
   * @secure
   */
  paymentsCashflowsCreate = (
    ...
    this.request<PangeaInstallmentCashflow, PangeaPaymentError>({
      path: `/api/v2/payments/${paymentId}/cashflows/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/payments/{payment_id}/cashflows/
   * @secure
   */
   ...
   * @request PUT:/api/v2/payments/{payment_id}/cashflows/{cashflow_id}/
   * @secure
   */
  paymentsCashflowsUpdate = (
    ...
    this.request<PangeaInstallmentCashflow, PangeaPaymentError>({
      path: `/api/v2/payments/${paymentId}/cashflows/${cashflowId}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request DELETE:/api/v2/payments/{payment_id}/cashflows/{cashflow_id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/payments/{payment_id}/cashflows/{cashflow_id}/
   * @secure
   */
   ...
   * @request POST:/api/v2/payments/bulk-payments/
   * @secure
   */
  paymentsBulkPaymentsCreate = (
    ...
    this.request<PangeaBulkPaymentResponse, any>({
      path: `/api/v2/payments/bulk-payments/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request PUT:/api/v2/payments/bulk-payments/
   * @secure
   */
   ...
   * @request POST:/api/v2/payments/bulk-payments/validate/
   * @secure
   */
  paymentsBulkPaymentsValidateCreate = (
    ...
    this.request<
      ...
      PangeaBulkPaymentValidationErrorResponse
    >({
      path: `/api/v2/payments/bulk-payments/validate/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/payments/bulk-payments-rfq/
   * @secure
   */
  paymentsBulkPaymentsRfqCreate = (
    ...
    this.request<PangeaBulkRfqStatus, any>({
      path: `/api/v2/payments/bulk-payments-rfq/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/payments/bulk-payments-execution/
   * @secure
   */
  paymentsBulkPaymentsExecutionCreate = (
    ...
    this.request<PangeaBulkExecutionStatus, any>({
      path: `/api/v2/payments/bulk-payments-execution/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/payments/market-spot-dates/
   * @secure
   */
  paymentsMarketSpotDatesCreate = (
    ...
    this.request<PangeaMarketSpotDates, any>({
      path: `/api/v2/payments/market-spot-dates/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/notification/events/
   * @secure
   */
  notificationEventsList = (
    ...
    this.request<PangeaPaginatedNotificationEventList, any>({
      path: `/api/v2/notification/events/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/notification/user/
   * @secure
   */
   ...
   * @request GET:/api/v2/notification/user/
   * @secure
   */
   ...
   * @request PUT:/api/v2/notification/user/bulk_create_update/
   * @secure
   */
  notificationUserBulkCreateUpdateUpdate = (
    ...
    this.request<PangeaUserNotificationBulkCreateUpdate[], Record<string, any>>(
      {
        path: `/api/v2/notification/user/bulk_create_update/`,
        method: 'PUT',
        body: data,
        secure: true,
        type: ContentType.Json,
   ...
   * @request PUT:/api/v2/notification/user/{id}/
   * @secure
   */
  notificationUserUpdate = (
    ...
    this.request<PangeaUserNotification, any>({
      path: `/api/v2/notification/user/${id}/`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request DELETE:/api/v2/notification/user/{id}/
   * @secure
   */
   ...
   * @request GET:/api/v2/notification/user/{id}/
   * @secure
   */
   ...
   * @request PATCH:/api/v2/notification/user/{id}/
   * @secure
   */
   ...
   * @request POST:/api/v2/notification/resend
   * @secure
   */
  notificationResendCreate = (
    ...
    this.request<PangeaResendNotificationResponse, any>({
      path: `/api/v2/notification/resend`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/ib/eca/application
   * @secure
   */
  brokerIbEcaApplicationCreate = (
    ...
    this.request<PangeaIBApplications, any>({
      path: `/api/v2/broker/ib/eca/application`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/ib/eca/sso_url
   * @secure
   */
  brokerIbEcaSsoUrlCreate = (
    ...
    this.request<PangeaCreateECASSOResponse, any>({
      path: `/api/v2/broker/ib/eca/sso_url`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/broker/ib/eca/account_status
   * @secure
   */
  brokerIbEcaAccountStatusRetrieve = (
    ...
    this.request<PangeaIBAccountStatusResponse, any>({
      path: `/api/v2/broker/ib/eca/account_status`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/ib/eca/pending_tasks
   * @secure
   */
  brokerIbEcaPendingTasksRetrieve = (
    ...
    this.request<PangeaPendingTasksResponse, any>({
      path: `/api/v2/broker/ib/eca/pending_tasks`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/ib/eca/registration_tasks
   * @secure
   */
  brokerIbEcaRegistrationTasksRetrieve = (
    ...
    this.request<PangeaRegistrationTasksResponse, any>({
      path: `/api/v2/broker/ib/eca/registration_tasks`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/ib/fb/instruction_name
   * @secure
   */
  brokerIbFbInstructionNameRetrieve = (
    ...
    this.request<PangeaIBFBResponse, any>({
      path: `/api/v2/broker/ib/fb/instruction_name`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/broker/ib/fb/deposit_funds
   * @secure
   */
  brokerIbFbDepositFundsCreate = (
    ...
    this.request<PangeaIBFBResponse, any>({
      path: `/api/v2/broker/ib/fb/deposit_funds`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/ib/fb/withdraw_fund
   * @secure
   */
  brokerIbFbWithdrawFundCreate = (
    ...
    this.request<PangeaIBFBResponse, any>({
      path: `/api/v2/broker/ib/fb/withdraw_fund`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/broker/ib/fb/status
   * @secure
   */
  brokerIbFbStatusRetrieve = (
    ...
    this.request<PangeaIBFBResponse, any>({
      path: `/api/v2/broker/ib/fb/status`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/ib/fb/funding_requests
   * @secure
   */
  brokerIbFbFundingRequestsList = (
    ...
    this.request<PangeaPaginatedFundingRequestList, any>({
      path: `/api/v2/broker/ib/fb/funding_requests`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/ib/fb/wire_instructions
   * @secure
   */
  brokerIbFbWireInstructionsList = (
    ...
    this.request<PangeaPaginatedWireInstructionList, any>({
      path: `/api/v2/broker/ib/fb/wire_instructions`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/broker/ib/fb/predefined_destination_instruction
   * @secure
   */
  brokerIbFbPredefinedDestinationInstructionCreate = (
    ...
    this.request<PangeaFundingRequest, any>({
      path: `/api/v2/broker/ib/fb/predefined_destination_instruction`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/broker/ib/contract/detail/{symbol}
   * @secure
   */
  brokerIbContractDetailRetrieve = (
    ...
    this.request<PangeaFutureContract, any>({
      path: `/api/v2/broker/ib/contract/detail/${symbol}`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/broker/ib/contract/{base}
   * @secure
   */
  brokerIbContractList = (base: string, params: RequestParams = {}) =>
    this.request<PangeaFutureContract[], any>({
      path: `/api/v2/broker/ib/contract/${base}`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/broker/ib/contract/active/{base}
   * @secure
   */
  brokerIbContractActiveList2 = (base: string, params: RequestParams = {}) =>
    this.request<PangeaFutureContract[], any>({
      path: `/api/v2/broker/ib/contract/active/${base}`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/broker/ib/contract/active/
   * @secure
   */
  brokerIbContractActiveList = (params: RequestParams = {}) =>
    this.request<PangeaFutureContract[], any>({
      path: `/api/v2/broker/ib/contract/active/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/broker/ib/system/companies/
   * @secure
   */
  brokerIbSystemCompaniesRetrieve = (params: RequestParams = {}) =>
    this.request<number[], any>({
      path: `/api/v2/broker/ib/system/companies/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/broker/corpay/spot/rate
   * @secure
   */
  brokerCorpaySpotRateCreate = (
    ...
    this.request<PangeaSpotRateResponse, any>({
      path: `/api/v2/broker/corpay/spot/rate`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/spot/book-deal
   * @secure
   */
  brokerCorpaySpotBookDealCreate = (
    ...
    this.request<PangeaBookDealResponse, any>({
      path: `/api/v2/broker/corpay/spot/book-deal`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/spot/instruct-deal
   * @secure
   */
  brokerCorpaySpotInstructDealCreate = (
    ...
    this.request<PangeaInstructDealResponse, any>({
      path: `/api/v2/broker/corpay/spot/instruct-deal`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/spot/book-instruct-deal
   * @secure
   */
  brokerCorpaySpotBookInstructDealCreate = (
    ...
    this.request<PangeaInstructDealResponse, any>({
      path: `/api/v2/broker/corpay/spot/book-instruct-deal`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/broker/corpay/spot/purpose-of-payment
   * @secure
   */
  brokerCorpaySpotPurposeOfPaymentRetrieve = (
    ...
    this.request<PangeaPurposeOfPaymentResponse, any>({
      path: `/api/v2/broker/corpay/spot/purpose-of-payment`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/corpay/fx-balance/accounts
   * @secure
   */
  brokerCorpayFxBalanceAccountsRetrieve = (
    ...
    this.request<PangeaFXBalanceAccountsResponse, any>({
      path: `/api/v2/broker/corpay/fx-balance/accounts`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/corpay/fx-balance/history
   * @secure
   */
  brokerCorpayFxBalanceHistoryList = (
    ...
    this.request<PangeaPaginatedFXBalanceAccountHistoryRowList, any>({
      path: `/api/v2/broker/corpay/fx-balance/history`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/corpay/fx-balance/company
   * @secure
   */
  brokerCorpayFxBalanceCompanyList = (
    ...
    this.request<PangeaPaginatedCompanyFXBalanceAccountHistoryList, any>({
      path: `/api/v2/broker/corpay/fx-balance/company`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/corpay/beneficiary/banks
   * @secure
   */
  brokerCorpayBeneficiaryBanksRetrieve = (
    ...
    this.request<PangeaListBankResponse, any>({
      path: `/api/v2/broker/corpay/beneficiary/banks`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/broker/corpay/beneficiary/iban-validation
   * @secure
   */
  brokerCorpayBeneficiaryIbanValidationCreate = (
    ...
    this.request<PangeaIbanValidationResponse, any>({
      path: `/api/v2/broker/corpay/beneficiary/iban-validation`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/broker/corpay/beneficiary/rules
   * @secure
   */
  brokerCorpayBeneficiaryRulesRetrieve = (
    ...
    this.request<PangeaBeneficiaryRulesResponse, any>({
      path: `/api/v2/broker/corpay/beneficiary/rules`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/corpay/beneficiary
   * @secure
   */
  brokerCorpayBeneficiaryRetrieve = (
    ...
    this.request<PangeaRetrieveBeneficiaryResponse, any>({
      path: `/api/v2/broker/corpay/beneficiary`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/broker/corpay/beneficiary
   * @secure
   */
   ...
   * @request DELETE:/api/v2/broker/corpay/beneficiary
   * @secure
   */
   ...
   * @request GET:/api/v2/broker/corpay/beneficiaries
   * @secure
   */
  brokerCorpayBeneficiariesRetrieve = (
    ...
    this.request<PangeaListBeneficiaryResponse, any>({
      path: `/api/v2/broker/corpay/beneficiaries`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/broker/corpay/client-onboarding
   * @secure
   */
  brokerCorpayClientOnboardingCreate = (
    ...
    this.request<PangeaOnboardingResponse, any>({
      path: `/api/v2/broker/corpay/client-onboarding`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/broker/corpay/client-onboarding/picklist
   * @secure
   */
  brokerCorpayClientOnboardingPicklistRetrieve = (
    ...
    this.request<PangeaOnboardingPickListResponse, any>({
      path: `/api/v2/broker/corpay/client-onboarding/picklist`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/broker/corpay/client-onboarding/upload
   * @secure
   */
  brokerCorpayClientOnboardingUploadCreate = (
    ...
    this.request<PangeaOnboardingFileUploadResponse, any>({
      path: `/api/v2/broker/corpay/client-onboarding/upload`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/broker/corpay/costs
   * @secure
   */
  brokerCorpayCostsRetrieve = (
    ...
    this.request<PangeaCostResponse, any>({
      path: `/api/v2/broker/corpay/costs`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request POST:/api/v2/broker/corpay/proxy
   * @secure
   */
  brokerCorpayProxyCreate = (
    ...
    this.request<PangeaProxy, any>({
      path: `/api/v2/broker/corpay/proxy`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/broker/corpay/fxpairs/
   * @secure
   */
  brokerCorpayFxpairsList = (
    ...
    this.request<PangeaPaginatedSupportedFxPairsList, any>({
      path: `/api/v2/broker/corpay/fxpairs/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/corpay/credit-utilization/
   * @secure
   */
  brokerCorpayCreditUtilizationList = (params: RequestParams = {}) =>
    this.request<PangeaCreditUtilization[], any>({
      path: `/api/v2/broker/corpay/credit-utilization/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/broker/corpay/currency-definition/
   * @secure
   */
  brokerCorpayCurrencyDefinitionList = (
    ...
    this.request<PangeaPaginatedCurrencyDefinitionList, any>({
      path: `/api/v2/broker/corpay/currency-definition/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/broker/corpay/currency-definition/{id}/
   * @secure
   */
  brokerCorpayCurrencyDefinitionRetrieve = (
    ...
    this.request<PangeaCurrencyDefinition, any>({
      path: `/api/v2/broker/corpay/currency-definition/${id}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/broker/corpay/spot/save-instruct-deal-request
   * @secure
   */
  brokerCorpaySpotSaveInstructDealRequestCreate = (
    ...
    this.request<PangeaSaveInstructRequestResponse, any>({
      path: `/api/v2/broker/corpay/spot/save-instruct-deal-request`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/forward/quote
   * @secure
   */
  brokerCorpayForwardQuoteCreate = (
    ...
    this.request<PangeaForwardQuoteResponse, any>({
      path: `/api/v2/broker/corpay/forward/quote`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/forward/book-quote
   * @secure
   */
  brokerCorpayForwardBookQuoteCreate = (
    ...
    this.request<PangeaForwardBookQuoteResponse, any>({
      path: `/api/v2/broker/corpay/forward/book-quote`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/forward/complete-order
   * @secure
   */
  brokerCorpayForwardCompleteOrderCreate = (
    ...
    this.request<PangeaForwardCompleteOrderResponse, any>({
      path: `/api/v2/broker/corpay/forward/complete-order`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/mass-payments/quote-payments
   * @secure
   */
  brokerCorpayMassPaymentsQuotePaymentsCreate = (
    ...
    this.request<PangeaQuotePaymentsResponse, any>({
      path: `/api/v2/broker/corpay/mass-payments/quote-payments`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/mass-payments/book-payments
   * @secure
   */
  brokerCorpayMassPaymentsBookPaymentsCreate = (
    ...
    this.request<PangeaBookPaymentsResponse, any>({
      path: `/api/v2/broker/corpay/mass-payments/book-payments`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/payment/quote
   * @secure
   */
  brokerCorpayPaymentQuoteCreate = (
    ...
    this.request<PangeaQuotePaymentResponse, any>({
      path: `/api/v2/broker/corpay/payment/quote`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/broker/corpay/payment/book
   * @secure
   */
  brokerCorpayPaymentBookCreate = (
    ...
    this.request<PangeaBookPaymentsResponse, any>({
      path: `/api/v2/broker/corpay/payment/book`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/marketing/fx/calculator/rate
   * @secure
   */
  marketingFxCalculatorRateCreate = (
    ...
    this.request<PangeaFxCalculatorResponse, any>({
      path: `/api/v2/marketing/fx/calculator/rate`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/marketing/demo-form/submit
   * @secure
   */
  marketingDemoFormSubmitCreate = (
    ...
    this.request<PangeaDemoResponse, any>({
      path: `/api/v2/marketing/demo-form/submit`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/ndl/sge/detail/{currency_code}/{value_type}/
   * @secure
   */
  ndlSgeDetailList = (
    currencyCode: string,
    ...
    this.request<Pangea_SGE[], Record<string, any>>({
      path: `/api/v2/ndl/sge/detail/${currencyCode}/${valueType}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request GET:/api/v2/ndl/sge/average/p10/{value_type}/
   * @secure
   */
  ndlSgeAverageP10Retrieve = (valueType: string, params: RequestParams = {}) =>
    this.request<void, any>({
      path: `/api/v2/ndl/sge/average/p10/${valueType}/`,
      method: 'GET',
      secure: true,
      ...params,
    });
   ...
   * @request GET:/api/v2/dataprovider/profile/parallel-option
   * @secure
   */
  dataproviderProfileParallelOptionRetrieve = (
    ...
    this.request<PangeaProfileParallelOptionResponse, any>({
      path: `/api/v2/dataprovider/profile/parallel-option`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @tags broker
   * @name BrokerCreate
   * @request POST:/api/v2/broker/{broker}/{action}
   * @secure
   */
  brokerCreate = (action: string, broker: string, params: RequestParams = {}) =>
    this.request<void, any>({
      path: `/api/v2/broker/${broker}/${action}`,
      method: 'POST',
      secure: true,
      ...params,
    });
   ...
   * @tags slack
   * @name SlackCreate
   * @request POST:/api/v2/slack/{action}
   * @secure
   */
  slackCreate = (action: string, params: RequestParams = {}) =>
    this.request<void, any>({
      path: `/api/v2/slack/${action}`,
      method: 'POST',
      secure: true,
      ...params,
    });
   ...
   * @request POST:/api/v2/approval/approver/
   * @secure
   */
   ...
   * @request POST:/api/v2/approval/request-payment-approval/
   * @secure
   */
  approvalRequestPaymentApprovalCreate = (
    ...
    this.request<PangeaActionStatus, PangeaActionStatus | PangeaPaymentError>({
      path: `/api/v2/approval/request-payment-approval/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request GET:/api/v2/approval/approve-request/
   * @secure
   */
  approvalApproveRequestRetrieve = (
    ...
    this.request<PangeaActionStatus, PangeaActionStatus | PangeaPaymentError>({
      path: `/api/v2/approval/approve-request/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   *
   * @tags history
   * @name HistoryFeesPaymentsList
   * @request GET:/api/v2/history/fees-payments/
   * @secure
   */
  historyFeesPaymentsList = (
    query: PangeaHistoryFeesPaymentsListParams,
    params: RequestParams = {},
  ) =>
    this.request<PangeaPaginatedFeesPaymentsList, any>({
      path: `/api/v2/history/fees-payments/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/history/fees-payments/{id}/
   * @secure
   */
  historyFeesPaymentsRetrieve = (id: string, params: RequestParams = {}) =>
    this.request<PangeaFeesPayments, any>({
      path: `/api/v2/history/fees-payments/${id}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   *
   * @tags history
   * @name HistoryBankStatementsList
   * @request GET:/api/v2/history/bank-statements/
   * @secure
   */
  historyBankStatementsList = (
    query: PangeaHistoryBankStatementsListParams,
    params: RequestParams = {},
  ) =>
    this.request<PangeaPaginatedBankStatementList, any>({
      path: `/api/v2/history/bank-statements/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/history/bank-statements/{id}/
   * @secure
   */
  historyBankStatementsRetrieve = (id: string, params: RequestParams = {}) =>
    this.request<PangeaBankStatement, any>({
      path: `/api/v2/history/bank-statements/${id}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   *
   * @tags history
   * @name HistoryTradesList
   * @request GET:/api/v2/history/trades/
   * @secure
   */
  historyTradesList = (
    query: PangeaHistoryTradesListParams,
    params: RequestParams = {},
  ) =>
    this.request<PangeaPaginatedTradeList, any>({
      path: `/api/v2/history/trades/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/history/trades/{id}/
   * @secure
   */
  historyTradesRetrieve = (id: string, params: RequestParams = {}) =>
    this.request<PangeaTrade, any>({
      path: `/api/v2/history/trades/${id}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   *
   * @tags history
   * @name HistoryActivitiesList
   * @request GET:/api/v2/history/activities/
   * @secure
   */
  historyActivitiesList = (
    query: PangeaHistoryActivitiesListParams,
    params: RequestParams = {},
  ) =>
    this.request<PangeaPaginatedActivityList, any>({
      path: `/api/v2/history/activities/`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @request GET:/api/v2/history/activities/{id}/
   * @secure
   */
  historyActivitiesRetrieve = (id: number, params: RequestParams = {}) =>
    this.request<PangeaActivity, any>({
      path: `/api/v2/history/activities/${id}/`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @request POST:/api/v2/history/cashflow_weight/
   * @secure
   */
  historyCashflowWeightCreate = (
    ...
    this.request<PangeaCashFlowWeightResponse, any>({
      path: `/api/v2/history/cashflow_weight/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/history/performance/
   * @secure
   */
  historyPerformanceCreate = (
    ...
    this.request<PangeaPerformanceResponse, any>({
      path: `/api/v2/history/performance/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/history/account_pnls
   * @secure
   */
  historyAccountPnlsCreate = (
    ...
    this.request<PangeaAccountPnLResponse, any>({
      path: `/api/v2/history/account_pnls`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/history/realized_volatility/
   * @secure
   */
  historyRealizedVolatilityCreate = (
    ...
    this.request<PangeaRealizedVolatilityResponse, any>({
      path: `/api/v2/history/realized_volatility/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @request POST:/api/v2/history/cashflow_abs_forward/
   * @secure
   */
  historyCashflowAbsForwardCreate = (
    ...
    this.request<PangeaCashflowAbsForwardResponse, any>({
      path: `/api/v2/history/cashflow_abs_forward/`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
